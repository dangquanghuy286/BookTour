...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 text-center transition-colors duration-300 dark:bg-slate-950">
      <h1 className="mb-4 text-5xl font-bold text-red-500 md:text-6xl dark:text-red-400">
        404
      </h1>
      <p className="mb-6 text-lg text-gray-700 md:text-xl lg:text-2xl dark:text-gray-300">
