      ...
      <div className="container  px-4 py-2 mx-auto space-y-8">
        ...
        >
          ...
          >
            ...
            tour và hoàn tiền của chúng tôi được thiết kế để mang lại sự linh
            hoạt tối đa cho khách hàng:
          </p>
          ...
          <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 mt-8 space-y-4 mb-4">
            <li>
              <strong>Hoàn tiền do điều kiện bất khả kháng:</strong> Liên hệ
          ...
          <p
            ...
            data-aos-delay="600"
          >
            Vui lòng đọc kỹ các điều khoản trước khi đặt tour để tránh những
